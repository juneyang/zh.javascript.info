...
代码是很容易出现错误的。你也很可能犯错误……哦，我在说什么？只要你是人，你 **一定** 会犯错误（在写代码的时候），除非你是 [机器人](https://en.wikipedia.org/wiki/Bender\_\(Futurama\))。
...
打开网页 [bug.html](../../01-getting-started/4-devtools/bug.html)。
...
![chrome](../../01-getting-started/4-devtools/chrome.png)
...
现在，我们能看到错误就够了。稍后，在 [info:debugging-chrome](info:debugging-chrome) 一节中，我们会重新更加深入地学习开发者工具。
...
![safari](../../01-getting-started/4-devtools/safari.png)
